...
import OrderRepositoryImpl from '../../interfaces/storage/OrderRepositoryImpl.mjs';
...
import OrderConverter from '../../interfaces/converters/OrderConverter.mjs';
...
export default [
  ...
  {
    create: async (r) => new OrderRepositoryImpl({
      db: await r(Sequelize),
    }),
    as: OrderRepository,
  },
  ...
  {
    create: async (r) => new OrderConverter(),
    as: OrderConverter,
  },
