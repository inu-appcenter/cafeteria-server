...
import NotificationSerializer from '../../interfaces/serializers/NotificationSerializer';
...
export default [
  ...
  {
    create: async (r) => new GetNotifications({
      interactionRepository: await r(InteractionRepository),
    }),
    as: GetNotifications,
  },
  ...
  {
    create: async (r) => new NotificationSerializer(),
    as: NotificationSerializer,
  },
  {
