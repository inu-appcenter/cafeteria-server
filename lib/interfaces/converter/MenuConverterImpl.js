 ...
 * @param	{Object} cornerMenuKeys array of (id, FOODMENU_TYPE, TYPE1, and TYPE2).
 * @return	{array}	array of {@link Menu}.
 */
function _parse(rawObject, cornerMenuKeys) {
	if (!rawObject) {
...
module.exports = class {
	...
	convert(rawObject) {
		return _parse(rawObject, this.cornerMenuKeys);
	}
