...
const validateDiscountTransaction = resolve(ValidateDiscountTransaction);
const legacyTransactionConverter = resolve(LegacyTransactionConverter);
const commitDiscountTransaction = resolve(CommitDiscountTransaction);
const activateBarcode = resolve(ActivateBarcode);
