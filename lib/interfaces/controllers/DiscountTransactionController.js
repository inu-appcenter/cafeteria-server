 ...
 * Instances
 */
const transactionRepository = new TransactionRepository(new TransactionRepositoryImpl());
...
const transactionConverter = new LegacyTransactionConverter(new LegacyTransactionConverterImpl(barcodeTransformer));

const transactionValidator = new DiscountTransactionValidator(new DiscountTransactionValidatorImpl());
