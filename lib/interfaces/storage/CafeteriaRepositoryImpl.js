...
class CafeteriaRepositoryImpl extends CafeteriaRepository {
   ...
   * @return {Promise<exports|null>} Cafeteria instance if succeeded, or null.
   */
   ...
   * @param {Date} date target date of menus.
   * @return {Promise<[]>} array of menus.
   * @private
   */
