...
module.exports = class {
	...
	constructor() {
		...
		this.userDiscountStatusModel = this.db.model('user_discount_rule');
				...
				where: sequelize.and(
					{
						 ...
						 * a candidate key of a transaction (without knowing the primary key).
						 */
						user_id: userId,
						cafeteria_id: cafeteriaId
					},
	...
	/**
	 * This method will be requested by validator.
	 * See @domain/validators/DiscountTransactionValidator.
	 */
	async getAllTransactionsToday(userId) {
