...
class CloudMessageRepositoryImpl extends CloudMessageRepository {
  ...
  async sendOrderReadyMessage(order) {
    ...
    const message = this._composeMessage(order);

    return await this._sendMessageSafe(message);
  }

  async _sendMessageSafe(message) {
    try {
