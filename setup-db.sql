CREATE TABLE IF NOT EXISTS `cafeteria` (`id` INTEGER NOT NULL , `name` VARCHAR(255) NOT NULL, `imagePath` VARCHAR(255), PRIMARY KEY (`id`)) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS `corners` (`cafeteriaId` INTEGER NOT NULL, `id` INTEGER NOT NULL , `name` VARCHAR(255), PRIMARY KEY (`id`)) ENGINE=InnoDB;
